...
BUILDROOT_MAKE = $(MAKE) -C $(BUILDROOT_SRC_DIR)
...
$(BUILDROOT_CONFIG): .gitmodules $(BUILDROOT_DEFCONFIG)
	$(BUILDROOT_MAKE) O=$(BUILDROOT_BUILD_DIR) BR2_DL_DIR=$(BUILDROOT_DL_DIR) allnoconfig
	$(BUILDROOT_MAKE) BR2_DEFCONFIG=$(BUILDROOT_DEFCONFIG) defconfig
